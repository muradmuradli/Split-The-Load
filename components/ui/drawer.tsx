    ...
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "data-[vaul-drawer-direction=right]:inset-y-0 data-[vaul-drawer-direction=right]:right-0 data-[vaul-drawer-direction=right]:left-0 data-[vaul-drawer-direction=right]:sm:left-auto data-[vaul-drawer-direction=right]:sm:w-3/4 data-[vaul-drawer-direction=right]:sm:max-w-sm border-r-2 border-r-border",
          "data-[vaul-drawer-direction=left]:inset-y-0 data-[vaul-drawer-direction=left]:left-0 data-[vaul-drawer-direction=left]:right-0 data-[vaul-drawer-direction=left]:sm:right-auto data-[vaul-drawer-direction=left]:sm:w-3/4 data-[vaul-drawer-direction=left]:sm:max-w-sm border-l-2 border-l-border",
          className,
        )}
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-2 w-25 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block bg-current" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
